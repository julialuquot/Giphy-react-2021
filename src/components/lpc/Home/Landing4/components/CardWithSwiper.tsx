...
import SlideOne from '@components/lpc/Home/Landing4/components/SlideOne/SlideOne';
import SlideTwo from '@components/lpc/Home/Landing4/components/SlideTwo/SlideTwo';
import SlideThree from '@components/lpc/Home/Landing4/components/SlideThree/SlideThree';
