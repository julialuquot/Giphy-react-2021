...
import SpendingWay from '@components/lpc/Home/Landing3/component/SpendingWay';
    ...
    return (
        <div className={css.wrapper}>
            <div className={css.icon}>
                ...
                <img className={css.icon__wallet_left} src="/images/old/wallet.png" alt={'wallet'} />
                <img className={css.icon__wallet_right} src="/images/old/wallet.png" alt={'wallet'} />
            </div>
